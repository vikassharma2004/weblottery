...
export default function ReferEarnPage() {
  ...
  if (error)
    return <div className="p-10 text-center text-red-500">Failed to load referral data.</div>;
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="w-full flex items-center justify-center gap-4">
            ...
            <span className="text-base md:text-lg font-semibold text-emerald-700 text-center whitespace-nowrap">
              Till now, <span className="font-bold">3+ users</span> have trusted us
            </span>
          </div>
        </div>
      </div>
          ...
          <div className="flex flex-col justify-center gap-8">
            ...
            <div>
              ...
              <p className="mt-4 text-lg text-stone-600 leading-relaxed">
                Invite your friends using your unique link. When they register and complete their payment, 
                you instantly earn ₹100.
              </p>
            </div>
            ...
            <div className="rounded-xl bg-white p-6 border border-stone-200 shadow-sm">
              ...
              {info.hasPaid ? (
                ...
                <div className="px-4 py-4 rounded-lg bg-stone-100 border border-stone-200 text-stone-600 text-sm">
                  Complete your payment to unlock your referral link and start earning rewards.
                </div>
              )}
            ...
            <div className="grid grid-cols-2 gap-4 pt-4 border-t border-stone-200">
              <div>
                <div className="text-2xl font-bold text-amber-500">{info.totalReferrals}</div>
                <p className="text-sm text-stone-600 mt-1">Friends Referred</p>
              </div>

              <div>
                <div className="text-2xl font-bold text-amber-500">₹{info.amountEarned}</div>
